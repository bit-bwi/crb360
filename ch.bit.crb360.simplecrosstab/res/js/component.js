define(["sap/designstudio/sdk/component", "css!../css/component.css"], function(Component, css) {
	Component.subclass("ch.bit.crb360.simplecrosstab.SimpleCrosstab", function() {

/***********************************************************************/
/********* ch.bit.crb360.simplecrosstab v 1.01.0.0.20190612 *************/
/***********************************************************************/
	...
	var CSS_CLASS_TD_HEADER  = "TableHeader";
	var CSS_CLASS_TD_HEADER_BOLD = "TableHeader";
	var CSS_CLASS_TD_DEFAULT_EVEN = "TableData";
	var CSS_CLASS_TD_DEFAULT_ODD = "TableData";
	var CSS_CLASS_TD_DEFAULT_BOLD_EVEN = "TableData";
	var CSS_CLASS_TD_DEFAULT_BOLD_ODD = "TableData";
...
//		this.$().css("overflow-y", "scroll");
	...
	function renderTable() {
	    that.$().empty();		
		var html = "<table width=\"100%\" cellspacing=\"0\" class=\"Table\">";
...
//					if (iGridRow > 1 && iGridCol == 0) {
					if (iGridRow > 0) {
						if (sGridType == "data-even" || sGridType == "data-odd") {
							html += " class=\"TableCol TableData\"";
						} else {
							html += " class=\"TableCol\"";
						}
					} else {
